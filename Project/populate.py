...
#
# import random
# from coreapp.models import MyUser, UserDetail, Partner, Project, ProjectDetail, ProjectManager, Developer
...
#         userdetails = UserDetail.objects.get_or_create(user=users, photo=fake_photo, contact=fake_contact, location=fake_location, position=fake_position,work=fake_work, cv=fake_cv)[0]
